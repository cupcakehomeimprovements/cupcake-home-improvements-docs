...
| Thermal Performance Potential | Dependent on existing frame | Higher potential |
| Installation Speed | Faster | Slower |
| Interior Finish Work | Typically none | Required |
| Reliance on Existing Frame | High | Reduced |
